// The Nutanix infrastructure provider, as its own module.
//
// Separate because its dependency graph is: the Nutanix SDK is ten modules
// and pulls a further twelve of the AWS SDK behind it, and none of that
// belongs in the graph of a repository whose other three managers do not
// touch Nutanix at all. ADR-0004 names this split; this is its first instance.
//
// "nutanix-infrastructure", not "nutanix": Cluster API providers are typed,
// and there are Nutanix providers of other types. The type is part of the
// name everywhere - module, binary and APIExport alike.
module github.com/jimmidyson/kcp-cluster-api/providers/nutanix-infrastructure

go 1.26.3

require (
	github.com/jimmidyson/kcp-cluster-api v0.0.0
...
require (
	...
	github.com/nutanix/ntnx-api-golang-clients/vmm-go-client/v4 v4.2.1 // indirect
	...
	sigs.k8s.io/cluster-api/test v1.15.0-kcp.11 // indirect
...
replace github.com/jimmidyson/kcp-cluster-api => ../..

// These four restate the parent's pins, and they have to: Go honours replace
