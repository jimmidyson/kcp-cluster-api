...
replace sigs.k8s.io/cluster-api => github.com/jimmidyson/cluster-api v1.15.0-kcp.11.0.20260820160642-a0d8d117bab2

replace sigs.k8s.io/cluster-api/api => github.com/jimmidyson/cluster-api/api v1.15.0-kcp.11.0.20260820160642-a0d8d117bab2

replace sigs.k8s.io/cluster-api/test => github.com/jimmidyson/cluster-api/test v1.15.0-kcp.11.0.20260820160642-a0d8d117bab2
