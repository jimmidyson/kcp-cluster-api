...
import (
	...
	"sigs.k8s.io/cluster-api/kcp/internal/kcpfixtures"
	kcpenvtest "sigs.k8s.io/cluster-api/kcp/test/integration/envtest"
...
var crdPaths = []string{
	...
	"../../../../test/infrastructure/docker/config/crd/bases/infrastructure.cluster.x-k8s.io_devmachines.yaml",
}

var webhookManifestPaths = []string{
	"../../../../core/config/webhook/manifests.yaml",
	"../../../../test/infrastructure/docker/config/webhook/manifests.yaml",
}
