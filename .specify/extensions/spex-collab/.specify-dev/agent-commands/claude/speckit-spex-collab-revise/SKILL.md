---
name: speckit-spex-collab-revise
...
metadata:
  ...
  source: spex-collab:commands/speckit.spex-collab.revise.md
---
...
{harness:interactive-choice} (multi-select, header: "Feedback"):
...
{harness:interactive-choice} (single-select, header: "Revise"):
